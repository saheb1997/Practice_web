...
export default function Card({username , btnText = "notPassed"}) {
     console.log(btnText);
  return (
    ...
    <div className="p-6 text-center">
        ...
        <a href="https://www.pexels.com/@kema/" className="inline-flex items-center text-white bg-blue-600 box-border border border-transparent hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 shadow-sm font-medium leading-5 rounded-lg text-sm px-4 py-2.5 focus:outline-none" target='_blank'>
            {btnText}
